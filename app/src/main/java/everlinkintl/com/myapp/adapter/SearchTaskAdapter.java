...
import everlinkintl.com.myapp.activity.transport.SearchTaskActivity;
import everlinkintl.com.myapp.datatemplate.FirstTab;

public class SearchTaskAdapter extends MyBaseAdapter{
    SearchTaskActivity mActivity;
    public SearchTaskAdapter(Context context, SearchTaskActivity activity) {
        super(context);

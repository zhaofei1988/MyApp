...
import everlinkintl.com.myapp.activity.transport.SealingBoxNumActivity;
import everlinkintl.com.myapp.datatemplate.PictureData;
import everlinkintl.com.myapp.view.PictureDialog;

public class BoxDataPictureAdapter extends MyBaseAdapter {
    private Context mContext;
    private SealingBoxNumActivity mUpDataPictureActivity;
    public BoxDataPictureAdapter(Context context, SealingBoxNumActivity upDataPictureActivity) {
        super(context);
